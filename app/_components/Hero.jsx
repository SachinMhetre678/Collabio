        ...
        <div className="relative pt-36 ml-auto">
          <div className="lg:w-2/3 text-center mx-auto">
            <h1 className="text-gray-900 dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl">
              Collabio is where <span className="text-primary dark:text-white">collaboration thrives.</span>
            </h1>
            ...
            <div className="hidden py-8 mt-16 border-y border-gray-100 dark:border-gray-800 sm:flex justify-between">
              <div className="text-left">
                ...
                <p className="mt-2 text-gray-500">Unlock exceptional value with our cost-effective solutions.</p>
              </div>
              <div className="text-left">
                <h6 className="text-lg font-semibold text-gray-700 dark:text-white">The fastest on the market</h6>
                <p className="mt-2 text-gray-500">Accelerate your workflow with our streamlined tools.</p>
              </div>
              <div className="text-left">
                <h6 className="text-lg font-semibold text-gray-700 dark:text-white">The most loved</h6>
                <p className="mt-2 text-gray-500">Join a community that values collaboration and creativity.</p>
              </div>
            </div>
          </div>
        </div>
